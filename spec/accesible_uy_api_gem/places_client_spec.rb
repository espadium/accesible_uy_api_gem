...
describe 'places_new' do
  it 'should post a new place' do
    name = 'Name'
    lat  = '-20'
    lon  = '-33'
    resp = {"id"=>1, "name"=>"Name", "address"=>nil, "author_id"=>1, "client_id"=>1, "created_at"=>"2014-09-13T05:31:30.682Z", "updated_at"=>"2014-09-13T05:31:30.682Z", "latitude"=>-20, "longitude"=>-33 }
    AccesibleUyApiGem.client.stub(:post) { resp }
    AccesibleUyApiGem.client.new_place(name, lat, lon).should eq(resp)
  end
end
